    ...
    <div className="w-full max-w-5xl mx-auto space-y-12 relative px-4">
          ...
          >
            ...
            >
              ...
              <div className="space-y-2">
                <h2 className="text-2xl font-bold text-white">Excel Converted!</h2>
      ...
      <div className="text-center space-y-4">
        ...
        <p className="text-lg text-slate-400 max-w-2xl mx-auto">
          Convert spreadsheets to PDF documents. Supports both .xlsx and .xls files.
        </p>
      </div>
      ...
      <div className="space-y-4">
          ...
          >
            ...
            <p className="text-xl font-semibold text-white">
                {isDragActive ? "Drop Excel file here" : "Select Excel file"}
            </p>
